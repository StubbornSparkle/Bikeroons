...
public class chooseDestination3_activity extends  AppCompatActivity {
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(chooseDestination3_activity.this, start_activity.class));
    }
    ...
    void startService(){
        try{
            ...
            Intent intent = new Intent(chooseDestination3_activity.this, LocationService.class );
            startService(intent);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if(internetIsConnected()){
            ...
            handlerr.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    GeoPoint startPoint = new GeoPoint(myx, myy);
            ...
            start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(destChosen){
                        if(shared){
                            Intent intent = new Intent(chooseDestination3_activity.this, chooseBike_activity.class);
                            intent.putExtra("workout", false);
                            intent.putExtra("distance", distance);
                            intent.putExtra("dest", (Parcelable) dest);
                            startActivity(intent);
                        }else{
                            Intent intent = new Intent(chooseDestination3_activity.this, ride_activity.class);
