...
public class workoutRide_activity extends Activity implements Serializable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(internetIsConnected()){
            ...
            getWeather2();
            mapSetup ms = new mapSetup(workoutRide_activity.this);
            ms.execute();
           ...
           // myLoc.setVisibility(View.GONE);
            ...
            yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    gs.cancel(true);
                    stopService();
                    startActivity(new Intent(workoutRide_activity.this, rideSummary_activity.class));
                }
            });
          ...
          //  myLoc.setVisibility(View.GONE);
            ...
            switch((String)getIntent().getSerializableExtra("type")){
                ...
                case "calories":
                    ...
                    kmToArrival.setText("Calories burned");
    ...
    void startService(){
        try{
            ...
            Intent intent = new Intent(workoutRide_activity.this, LocationService.class );
            startService(intent);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals( "ACT_LOC")){
                ...
                if(!distanceMode && caloriesMode && !timeMode){
                    ...
                    double p = 0.004 * Double.parseDouble(fetchedSpeed) * ((weight+25)*9.80665);
                    caloriesBurnt += (((p/3600)/0.24)*0.75);
                  ...
                  //  kmToArrivalNum.setText(Math.round(caloriesBurnt)+"");
                    kmToArrivalNum.setText(Math.nextUp(caloriesBurnt)+"");

                    int left = Integer.parseInt((Integer.parseInt((String)getIntent().getSerializableExtra("calories"))-caloriesBurnt)+"");
                    if(left == 0){
                        endRide();
                        goal.setText("0");
                    }else{
    ...
    public void endRide(){
        ...
        Intent intent = new Intent(workoutRide_activity.this, endRide_activity.class);
...
*/
    ...
    public class lockBike extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            if (response != null && response.getStatusLine().toString().equals("HTTP/1.1 500 Internal Server Error")) {
                Toast.makeText(workoutRide_activity.this, "An Error has occurred!", Toast.LENGTH_LONG).show();
    ...
    public class removeBike extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            if (response != null && response.getStatusLine().toString().equals("HTTP/1.1 500 Internal Server Error")) {
                ...
                Toast.makeText(workoutRide_activity.this, "Shared bike Disowned!", Toast.LENGTH_LONG).show();

                stopService();

                dr.cancel(true);
                gs.cancel(true);
                startActivity(new Intent(workoutRide_activity.this, start_activity.class));
            }
        }
    }
    ...
    private class mapSetup extends AsyncTask<Void, Void, Void> {
        ...
        public mapSetup(workoutRide_activity activity) {
